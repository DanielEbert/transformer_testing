...
optimizer = optim.Adam(model.parameters(), lr=1e-5)  # Start with a small learning rate
...
def classify_stock_chart(model, chart_data, scaler):
  ...
  chart_data = torch.tensor(chart_data, dtype=torch.float32).unsqueeze(0)  # Add batch dimension
